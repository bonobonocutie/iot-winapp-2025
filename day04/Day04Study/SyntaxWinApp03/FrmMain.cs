        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (DlgSave.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    if (ext == ".rtf") RtbNote.SaveFile(filePath, RichTextBoxStreamType.RichText);
                    else if (ext == ".txt") RtbNote.SaveFile(filePath, RichTextBoxStreamType.PlainText);
        ...
        private void BtnLoad_Click(object sender, EventArgs e)
        {
            ...
            if (DlgOpen.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    if (ext == ".rtf") RtbNote.LoadFile(filePath, RichTextBoxStreamType.RichText);
                    else if(ext == ".txt") RtbNote.LoadFile(filePath, RichTextBoxStreamType.PlainText);
