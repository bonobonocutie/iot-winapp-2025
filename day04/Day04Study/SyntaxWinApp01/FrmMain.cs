    ...
    public partial class FrmMain : Form
    {
        ...
        private void BtnCheck_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                person.Age = Convert.ToInt32(NudAge.Value); // 더 선호하는 방식
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("성별은 M/F 한 글자만 입력하세요", "예외", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            {
                MessageBox.Show("수는 0으로 나눌 수 없습니다", "예외", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            catch (Exception ex)
            {
